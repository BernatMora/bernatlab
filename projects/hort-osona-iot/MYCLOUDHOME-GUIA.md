...
que tens a la teva xarxa local. L'hem descobert a **<IP_LOCAL>**.
...
1. Finder → Xarxa
2. Busca el **My Cloud Home** (o `<IP_LOCAL>`)
...
sudo mount -t cifs //<IP_LOCAL>/Public /mnt/mycloudhome \
...
```
//<IP_LOCAL>/Public /mnt/mycloudhome cifs guest,uid=1000,gid=1000,iocharset=utf8 0 0
```
...
- `http://<IP_LOCAL>/Public/hort-osona/portal/index.html`
- `http://<IP_LOCAL>/Public/hort-osona/portal/`
...
mount -t smbfs //bernatmora@<IP_LOCAL>/Public /Volumes/MyCloudHome
...
```bash
# Muntar
sudo mount -t cifs //<IP_LOCAL>/Public /mnt/mycloudhome -o guest
...
3. Provar `ping <IP_LOCAL>` des del Mac
...
# Muntar amb debug
sudo mount -t cifs //<IP_LOCAL>/Public /mnt/mycloudhome -o guest,vers=3.0
```
