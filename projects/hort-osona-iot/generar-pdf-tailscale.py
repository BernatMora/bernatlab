...
story.append(Paragraph(
    '3. Et retornarà una IP com <b><TAILSCALE_IP></b> (les xifres varien)',
    P
))
...
story.append(Paragraph(
    'curl http://<IP_LOCAL>.1:8001/chat/health',
    CODE
))
story.append(Paragraph(
...
story.append(Paragraph(
    '🔁 <b>Substitueix <TAILSCALE_IP> per la teva IP real de Tailscale</b> '
